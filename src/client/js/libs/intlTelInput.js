...
(function (factory) {
    ...
    Plugin.prototype = {
        ...
        _setDropdownPosition: function () {
            ...
            console.log(this.dropdownHeight);
            this.dropdownHeight = 300 + 'px';
            console.log(this.dropdownHeight);
            if (!this.isMobile) {
...
// ---------------------------------------------------------------------------------------------------------
            ...
            var cN = '<div class="cN">this.selectedCountryData.name</div>';
            this.selectedFlagInner.html(  '<div class="cN">'+this.selectedCountryData.name+'</div>'  )
