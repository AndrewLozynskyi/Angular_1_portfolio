...
angular.module ( 'Dashboard.module' )
    ...
    .directive ( 'simpleLineChart', [ '$window', function ( $window ) {
        ...
        return {
            ...
            templateUrl: 'dashboard/directives/simple-chart-dynamic-table.html',
            link: function ( scope, element, attrs ) {

                var wrapChart = element[ 0 ].getElementsByClassName ( 'line-chart-simple' )[ 0 ];
                    ...
                    if ( lines.length ) {
                        ...
                        for ( var e in data[ lines[ 0 ] ] ) {
                            ...
                            for ( var i = 0; i < lines.length; i++ ) {
                                ...
                                obj[ lines[ i ] === 'salary' ? 'salary' : lines[ i ] ] = data[ lines[ i ] ][ e ];
