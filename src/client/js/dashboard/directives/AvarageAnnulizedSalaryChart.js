/**
 * @author Oleg .
 * avarage annulized salary chart ( countryies )
 */

angular.module( 'Dashboard.module' )

.directive( 'avarageAnnulizedSalaryChart', [ '$window', function ( $window ) {
    ...
    return {
        ...
        link: function ( scope, element, attrs ) {
            ...
            $window.addEventListener('resize', function () {
                ...
                var newChartData = { 'salary': scope.setData };
